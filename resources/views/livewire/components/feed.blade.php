<div class="flex flex-col gap-4 mb-5 relative" {{ when(!$userId, 'wire:poll.180s.keep-alive=checkNewPost') }}>
    @if ($hasNewPosts)
    ...
    @else
        <div class="flex justify-center mt-5 mb-5">
            <p class="text-center text-md font-semibold">Go and create your first post</p>
        </div>
    @endif
</div>
