<div class="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
    <div class="h-20 relative  mb-12">
        <img src="{{ asset('images/avatar4.png') }}" fill class="rounded-md" />
        <img src="{{ asset('images/avatar.png') }}"
            class="rounded-full object-cover w-12 h-12 absolute left-0 right-0 m-auto -bottom-16 ring-1 ring-white z-10" />
    </div>
    <div class="flex flex-col gap-2 h-20 items-center">
        ...
        <button class="bg-blue-500 text-white p-2 text-xs rounded-lg">
            My Profile
        </button>
    </div>
</div>
