<div class="flex rounded-md bg-white p-4 gap-4 flex-col">
    ...
    <div class="flex items-center justify-between text-xs my-1">
        <div class="flex gap-2">
            <div class="flex items-center gap-2 bg-slate-50 p-2 rounded-xl" x-data="{ isLiked: {{ $likedByme ? 1 : 0 }}, likedCount: {{ $likes }} }">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-4 cursor-pointer" :class="isLiked ? 'text-blue-500' : ''"
                    x-on:click="isLiked = !isLiked; likedCount = isLiked ? likedCount + 1 : likedCount - 1; $wire.like({{ $post->id }})">
            ...
            <div class="flex items-center gap-2 bg-slate-50 p-2 rounded-xl">
                ...
                <span class="text-gray-300">|</span>
                <span class="text-gray-500">
                    125 <span class="hidden md:inline">Comment</span>
                </span>
            </div>
        </div>
        <div>
            <div class="flex items-center gap-2 bg-slate-50 p-2 rounded-xl">
                ...
                <span class="text-gray-300">|</span>
                <span class="text-gray-500">
                    125 <span class="hidden md:inline">Shares</span>
                </span>
            </div>
        </div>
    </div>
