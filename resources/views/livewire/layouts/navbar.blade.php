            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" x-cloak
                    ...
                    <div class="flex flex-col gap-3 p-2">
                        <div class="flex gap-1 items-center p-2 cursor-pointer hover:bg-gray-200 dark:hover:bg-slate-600"
                        ...
                        <div class="flex gap-1 items-center p-2 hover:bg-gray-200 dark:hover:bg-slate-600">
