<div class="h-[calc(100vh-98px)] flex items-center justify-center">
    <div class="bg-white p-8 rounded-md shadow-md w-[400px]">
        ...
        <form class="flex flex-col gap-2" wire:submit.prevent="submitsignup">
            ...
            <button role="status" class="flex items-center justify-center border rounded-md border-blue-500 py-1"
                wire:loading wire:target="submitsignup, remove">
                <svg aria-hidden="true"
                    class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 self-center"
