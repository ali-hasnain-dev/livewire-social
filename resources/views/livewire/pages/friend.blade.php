<div class="flex flex-col gap-4 items-center justify-center mt-5" x-data="{ activeTab: 1 }">
    <div class="flex gap-6 dark:text-white items-center justify-center">
        <p class="text-sm cursor-pointer " @click="activeTab = 1">Search</p>
        <p class="text-sm cursor-pointer " @click="activeTab = 2">My Friends</p>
        <p class="text-sm cursor-pointer " @click="activeTab = 3">Pending Request</p>
    </div>
